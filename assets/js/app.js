        ...
        'data': {
            ...
            'features': [
                ...
                },
                {
                    ...
                    'properties': {
                        'description':
                            '<strong>Le Celtique</strong><p>Lieu ' +
                            '<a href="https://madmens5finale.eventbrite.com/" target="_blank" title="Opens in a new window">' +
                            'Celtique</a>, 12 Rue de Grenoble, 59610 Fourmies</p>',
                        'icon': 'bar-15'
                    },
                    'geometry': {
                        'type': 'Point',
                ...
                },
                {
                    ...
                    'properties': {
                        'description':
                            '<strong>Chez Samuel</strong><p>Mon adresse personnelle que personne ne sait !' +
                            ' <a href="https://tallulaeatbar.ticketleap.com/2012beachblanket/" target="_blank"' +
                            ' title="Opens in a new window">Samuel</a> </p>',
                        'icon': 'rocket-15'
                    },
                    'geometry': {
                        'type': 'Point',
